...
function init() {
  ...
  scene.applyMatrix4( new THREE.Matrix4().makeTranslation(10, -30, -32));
  ...
  // set id for renderer
  renderer.domElement.id = 'building-canvas'
  ...
  loader.load("./models/low-poly/scene.gltf", function (gltf) {
