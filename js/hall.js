...
const hallContent2 = hallContentHead2 + hallContentText2 + window.screen.height/10
console.log(hallContentText2)
console.log(hallContentHead2)
console.log(window.screen.height/10)
console.log(hallContent2)
